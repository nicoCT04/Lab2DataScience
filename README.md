...
- [ ] Entrega final: análisis catch22 (extracción de características, PCA, clustering, heatmaps,
      matriz de distancias) y modelo LSTM con características de catch22.
...
├── notebooks/
│   └── Lab2_LSTM.ipynb                          # Ejercicio 1: modelos LSTM + comparación
...
pip install tensorflow pandas numpy scikit-learn matplotlib seaborn statsmodels openpyxl ipykernel
